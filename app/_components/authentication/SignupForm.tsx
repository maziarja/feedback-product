      ...
      >
        ...
        >
          ...
          <input
            ...
            className={`w-full border-b-1 ${errors.name ? "border-red-400" : "border-gray-300"} py-2 text-base font-normal tracking-wide text-gray-800 transition-colors duration-200 outline-none`}
          />
          <AnimatePresence>
            {errors.name && (
              <motion.p
